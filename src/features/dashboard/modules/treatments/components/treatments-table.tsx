...
import { getTreatments, selectGetTreatments } from "@/store/treatments/treatments-slice"
...
type Props = {
    onEdit: (treatment: ITreatmentsItems) => void;
    onDelete: (treatment: ITreatmentsItems) => void;
    refreshKey?: number;
};
