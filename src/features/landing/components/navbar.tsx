    ...
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      >
        ...
        <button
          ...
          className="flex size-10 items-center justify-center rounded-full border border-ink-700 bg-ink-850/60 text-ink-100 lg:hidden"
          aria-expanded={open}
      ...
      <div
        id="mobile-nav"
        className={cn(
          "mx-4 overflow-hidden rounded-3xl border border-ink-700/70 bg-ink-900/95 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.4)] backdrop-blur-xl transition-[max-height,opacity,margin-top] duration-300 sm:mx-auto sm:max-w-4xl lg:hidden",
