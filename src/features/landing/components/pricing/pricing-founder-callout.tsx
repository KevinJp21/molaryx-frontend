...
export const PricingFounderCallout = () => {
  return (
    <div className="mx-auto mt-10 max-w-4xl rounded-2xl border border-accent-500/25 bg-accent-500/8 px-6 py-7 sm:px-8 sm:py-8">
          ...
          <ul className="mt-5 grid gap-2.5 sm:grid-cols-3">
            <li className="flex items-start gap-2 text-sm text-ink-200">
              <Check
                ...
                strokeWidth={2}
              />
              <span>Todas las funcionalidades del plan Professional.</span>
            </li>
            ...
            <li className="flex items-start gap-2 text-sm text-ink-200">
              <Check
                ...
                strokeWidth={2}
              />
              <span>Precio Founder exclusivo durante el lanzamiento.</span>
            </li>
            ...
            <li className="flex items-start gap-2 text-sm text-ink-200">
              <Check
                ...
                strokeWidth={2}
              />
              <span>Cupos limitados para los primeros consultorios registrados.</span>
            </li>
          </ul>
        </div>
      </div>
