  ...
  return (
    <footer className="border-t border-ink-200/80">
      <div className="default-container container-px mx-auto py-14 sm:py-16">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:gap-8">
            ...
            {FOOTER_COLUMNS.map((column) => (
              <div key={column.title}>
                <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-ink-600">
                  {column.title}
                </p>
                  ...
                  {column.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        ...
                        className="text-sm text-ink-700 transition-colors duration-200 hover:text-ink-950"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        <div className="mt-12 border-t border-ink-200/80 pt-6">
