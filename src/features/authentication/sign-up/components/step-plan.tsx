                ...
                return (
                  <button
                    ...
                    className={`relative flex items-start gap-4 rounded-2xl border p-4 text-left transition-all duration-200 sm:p-5 ${selected
                        ...
                        : 'border-ink-700 bg-ink-900/40 hover:border-ink-600 hover:bg-ink-850/50'
                      }`}
                  >
                    <span
                      className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition-colors ${selected ? 'border-accent-500 bg-accent-500' : 'border-ink-600'
                        }`}
                    >
                      {selected && (
                    ...
                    <div className="relative shrink-0 text-right">
                      {plan.price !== null ? (
                        plan.promotionPlan !== null ? (
                          <>
                            <span className="absolute -top-7 -right-10 shrink-0 rounded-full border border-accent-500/30 bg-accent-500 px-2.5 py-1 text-[11px] font-semibold text-ink-950">
                              Founder
                            </span>
