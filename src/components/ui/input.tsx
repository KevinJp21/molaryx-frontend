  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "h-auto w-full min-w-0 rounded-xl border border-ink-300 bg-ink-100 px-3.5 py-2.5 text-sm text-ink-950 outline-none transition-[border-color,box-shadow] duration-200",
