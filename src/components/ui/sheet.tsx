    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[state=open]:data-[side=right]:slide-in-from-right-full",
          "data-[state=open]:data-[side=top]:slide-in-from-top-full",
          "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:duration-200",
          "data-[state=closed]:data-[side=bottom]:slide-out-to-bottom-full",
          "data-[state=closed]:data-[side=left]:slide-out-to-left-full",
          "data-[state=closed]:data-[side=right]:slide-out-to-right-full",
          "data-[state=closed]:data-[side=top]:slide-out-to-top-full",
          className
        )}
        {...props}
      >
