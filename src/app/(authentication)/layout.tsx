...
export default function AuthenticationLayout({ children, }: { children: React.ReactNode; }) {
    ...
    return (
        <div className="relative min-h-dvh bg-ink-950 text-ink-100 lg:flex">
            {/* Brand panel */}
            <div className="relative hidden overflow-hidden bg-ink-900 lg:flex lg:flex-col lg:justify-between lg:p-12 lg:w-[44%] xl:w-2/5 ">
                <div className="pointer-events-none absolute inset-0 ">
                    <div className="absolute left-1/2 top-0 h-105 w-105 -translate-x-1/2 rounded-full bg-accent-500/25 blur-[130px] opacity-50" />
                    <div className="absolute bottom-0 right-0 h-70 w-70 rounded-full bg-coral-500/15 blur-[120px] opacity-50" />
                </div>
